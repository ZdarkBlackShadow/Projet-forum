...
--
-- Host: localhost
-- Generation Time: Jun 12, 2025 at 10:14 AM
...
CREATE TABLE `channel_invitation` (
  ...
  `user_id_invite` int(11) NOT NULL,
  `channel_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(11, 'images/users/10a5957ce50aa7c71d8503ef4d1bcbd6.webp'),
(12, 'images/users/pngwing.com.png'),
(13, 'images/users/pngwing.com.png'),
(14, '/images/users/default_image.png'),
(15, 'images/users/GuessMe.png'),
(16, 'images/users/GuessMe.png'),
(17, 'images/users/GuessMe.png');

-- --------------------------------------------------------

--
-- Table structure for table `image_than_user_can_access`
--

CREATE TABLE `image_than_user_can_access` (
  `user_id` int(11) NOT NULL,
  `image_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `up_down_vote` (`up_down_vote_id`, `up_down`) VALUES
(1, 0),
(2, 1),
(3, 2);
...
INSERT INTO `users` (`user_id`, `email`, `username`, `password`, `bio`, `last_conection`, `image_id`, `salt`) VALUES
(9, 'dark@gmail.com', 'dark', 'c27YYEhZJPXcIE4BUvQczz2AazasUYtVD8VZy6Sx1u9wmYvm5ebmPLpgl5031RK5LaWzwiE9RKt9r05dXiTYZw==', 'all the wold is dark', '2025-05-28 08:38:05', 11, '84VGOoVW8CTzbvmWG2SaHg=='),
(11, 'test@test2', 'test2', '81uB1tzqkBPTp2xivZ8jHJilDrrZZ3nn/DQuP75vAUklXjxEqXwjsDz9x0zUZPR3GCY1sE5UpQWFHCWib0rtMA==', 'test', '2025-05-28 10:15:50', 13, '+eLhrWhNOKGR2FkX2FLBCQ=='),
(14, 'test@test22', 'test22', 'OFSGOnrksFUKi6c2dprdER2G5UMMqn6OKHMUf1YtCqLNxTB5ei7mDjOvbUQHIr7dai91/DUv4OFgERC79A3MuA==', 'vnjsdnvjoef', '2025-06-03 07:36:17', 17, 'QQBq3mo7GuWFpYIwZC+I2Q==');
...
ALTER TABLE `channel_invitation`
  ADD PRIMARY KEY (`user_id_creator`,`user_id_invite`),
  ADD KEY `user_id_1` (`user_id_invite`),
...
--
-- Indexes for table `image_than_user_can_access`
--
ALTER TABLE `image_than_user_can_access`
...
--
ALTER TABLE `up_down_vote`
  MODIFY `up_down_vote_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `channel_invitation`
  ADD CONSTRAINT `channel_invitation_ibfk_1` FOREIGN KEY (`user_id_creator`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `channel_invitation_ibfk_2` FOREIGN KEY (`user_id_invite`) REFERENCES `users` (`user_id`);
...
--
ALTER TABLE `friend`
  ADD CONSTRAINT `friend_ibfk_1` FOREIGN KEY (`user_id_1`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `friend_ibfk_2` FOREIGN KEY (`user_id_2`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `friend_request`
--
ALTER TABLE `friend_request`
  ADD CONSTRAINT `friend_request_ibfk_1` FOREIGN KEY (`user_id_creator`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `friend_request_ibfk_2` FOREIGN KEY (`user_id_invite`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `image_than_user_can_access`
--
ALTER TABLE `image_than_user_can_access`
  ADD CONSTRAINT `image_than_user_can_access_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `image_than_user_can_access_ibfk_2` FOREIGN KEY (`image_id`) REFERENCES `image` (`image_id`);

--
-- Constraints for table `message`
--
ALTER TABLE `message`
  ADD CONSTRAINT `channel` FOREIGN KEY (`channel_id`) REFERENCES `channel` (`channel_id`),
